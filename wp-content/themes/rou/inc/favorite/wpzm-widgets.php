...
function wpzm_widget_init() {
    ...
    wp_register_sidebar_widget('wpzm-most_favorited_posts', '收藏最多的文章', 'wpzm_widget_view');
    ...
    wp_register_sidebar_widget('wpzm-users_favorites','我收藏的文章', 'wpzm_users_favorites_widget_view');
