...
function exampletheme_options_after() { ?>
	<div class="themes-inf"><a href="http://zmingcx.com/begin-guide.html" target="_blank" rel="external nofollow" class="url"><i class="cx cx-begin"></i> 在线使用说明 | <?php echo version; ?></a></div>
<?php
}
...
jQuery(document).ready(function() {
	...
	jQuery('#section-video_post').click(function() {
		jQuery('#section-video_post_id').fadeToggle(400);
	});

	if (jQuery('#section-video_post:checked').val() !== undefined) {
	...
	jQuery('#qq_online').click(function() {
		jQuery('#section-qq_name, #section-qq_id, #section-weixing_qr, #section-m_phone, #section-t_phone').fadeToggle(400);
	});

	if (jQuery('#qq_online:checked').val() !== undefined) {
		jQuery('#section-qq_name, #section-qq_id, #section-weixing_qr, #section-m_phone, #section-t_phone').show();
	}
	...
	jQuery('#ad_h').click(function() {
		jQuery('#section-ad_h_c, #section-ad_h_c_m, #section-ad_h_cr').fadeToggle(400);
	});
	if (jQuery('#ad_h:checked').val() !== undefined) {
		jQuery('#section-ad_h_c, #section-ad_h_c_m, #section-ad_h_cr').show();
	}
