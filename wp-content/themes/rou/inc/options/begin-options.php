...
// 公司主页
	...
	$options[] = array(
		...
		'desc' => '输入中间模块图片地址',
		'id' => 'service_c_img',
		'std' => 'https://wx3.sinaimg.cn/large/0066LGKLly1fgcbh8r7rcj31hc0dwtr7.jpg',
		'class' => 'hidden',
		'type' => 'text'
	);
	...
	$options[] = array(
		...
		'class' => 'hidden',
		 "std" => "https://wx4.sinaimg.cn/large/0066LGKLly1fgbupqu5utj31hc0dwdgt.jpg",
		'type' => 'upload'
	);
	...
	$options[] = array(
		...
		'desc' => '上传背景图片',
		'id' => 'personal_img',
        "std" => "https://wx3.sinaimg.cn/large/0066LGKLly1fhyn7crljrj30q405kglw.jpg",
		'type' => 'upload'
	);
...
*/
	...
	$options[] = array(
		'name' => '',
		'desc' => '<a href="' . home_url() . '/wp-admin/admin.php?page=front_settings">投稿设置页面</a>',
		'id' => 'setup_tougao',
		'class' => 'hidden'
	);
	...
	$options[] = array(
		...
		'id' => 'footer_inf_b',
		'class' => 'be_ico',
		'std' => '<a title="知更鸟你个渣渣正版都加恶意代码" href="http://zmingcx.com/" target="_blank"><img src="' . get_template_directory_uri() . '/img/logo.png" alt="Begin主题" width="120" height="27" /></a>',
		'type' => 'editor',
		'settings' => $wp_editor_settings
	);
	...
	$options[] = array(
		...
		'id' => 'ad_f',
		'class' => 'be_ico',
		'std' => '<a href="#" target="_blank"><img src="' . get_template_directory_uri() . '/img/random/long.jpg" alt="广告也精彩" /></a>',
		'type' => 'textarea'
	);
    ...
    $options[] = array(
		'name' => '页面宽度',
		'desc' => '默认值：1120，只适用于增加宽度，不使用自定义宽度请留空！',
		'id' => 'custom_width',
		'class' => 'be_ico',
		 'std' => '',
		'type' => 'text'
