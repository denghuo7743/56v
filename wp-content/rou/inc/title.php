...
<?php if ( is_tax('products') ) { ?><title><?php setTitle(); ?> <?php echo zm_get_option('connector'); ?> <?php bloginfo('name'); ?></title><?php } ?>
...
<?php if (function_exists( 'is_bbpress' )) { ?><?php if ( is_bbpress() && !is_single()) { ?><title><?php the_title();?> <?php echo zm_get_option('connector'); ?> <?php bloginfo('name'); ?></title><?php } ?><?php } ?>
<?php if ( is_tax('filtersa') || is_tax('filtersb') || is_tax('filtersc') ) { ?><title>筛选结果 <?php echo zm_get_option('connector'); ?> <?php bloginfo('name'); ?></title><?php } ?>
