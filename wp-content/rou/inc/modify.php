...
if ($menu_color) {
$styles .= "#site-nav .down-menu > li > a:hover,#site-nav .down-menu > li.sfHover > a {background: #" . $menu_color . ";border-bottom: 1px solid #" . $menu_color . "}";}
