<?php if (zm_get_option('grid_cat_c')) { ?>
<?php $display_categories =  explode(',',zm_get_option('grid_cat_c_id') ); foreach ($display_categories as $category) { ?>
	<?php query_posts( array( 'showposts' => zm_get_option('grid_cat_c_n'), 'cat' => $category, 'offset' => 0, 'post__not_in' => $do_not_duplicate ) ); ?>
