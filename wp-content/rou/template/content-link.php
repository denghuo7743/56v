	...
	<header class="entry-header">
		...
		<?php else : ?>
			<?php if ( get_post_meta($post->ID, 'direct', true) ) { ?>
				...
				<?php if ( get_post_meta($post->ID, 'mark', true) ) { ?>
					<h2 class="entry-title"><a href="<?php echo $direct ?>" target="_blank" rel="nofollow"><?php the_title(); ?></a><span class="t-mark"><?php $mark = get_post_meta($post->ID, 'mark', true);echo $mark; ?></span></h2>
				<?php } else { ?>
