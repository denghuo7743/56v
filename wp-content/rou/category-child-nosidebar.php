				...
				foreach($cats as $the_cat){
					...
					if(!empty($posts)){
						...
						<div class="child-post wow fadeInUp" data-wow-delay="0.3s">
							<h3 class="child-title cat-title"><span class="title-i"><span></span><span></span><span></span><span></span></span><a href="'.get_category_link($the_cat).'">'.$the_cat->name.'<span class="more-i"><span></span><span></span><span></span></span></a></h3>
							<ul class="child-list">';
