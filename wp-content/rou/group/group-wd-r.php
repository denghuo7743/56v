...
<div class="g-row <?php if (zm_get_option('bg_8')) { ?>g-line<?php } ?> sort" name="<?php echo zm_get_option('group_wd_r_s'); ?>">
	<div class="g-col">
		<div class="gr-wd-box">
			...
			<?php query_posts( array( 'showposts' => 1, 'cat' => $category, 'post__not_in' => $do_not_cat ) ); ?>
				<div class="gr-cat-wd">
					<h3 class="gr-cat-wd-title wow fadeInLeft" data-wow-delay="0.3s"><a href="<?php echo get_category_link($category);?>" title="<?php echo strip_tags(category_description($category)); ?>"><?php single_cat_title(); ?><span class="more-i"><span></span><span></span><span></span></span></a></h3>
					<div class="clear"></div>
				</div>

				<div class="gr-wd-b">
					<div class="gr-wd gr-wd-img gr-wd-img-r wow fadeInRight" data-wow-delay="0.3s">
					...
					<div class="gr-wd gr-wd-w gr-wd-r wow fadeInLeft" data-wow-delay="0.3s">
					<?php query_posts( array ( 'category__in' => array(get_query_var('cat')), 'meta_key' => 'cat_top', 'showposts' => 1, 'ignore_sticky_posts' => 1 ) ); while ( have_posts() ) : the_post(); $do_not_cat[] = $post->ID;?>
