		...
		<table class="form-table">
			...
			<tr>
				...
				<td>
					...
					例如：http://www.mobantu.com/user?pd=vip
				</td>
			</tr>
			<tr>
				...
				<td>
					...
					例如：http://www.mobantu.com/user?pd=money
				</td>
			</tr>
			<tr>
				<th valign="top">支付成功跳转地址</th>
				<td>
					<input type="text" id="erphp_url_front_success" name="erphp_url_front_success" value="<?php echo $erphp_url_front_success;?>" class="regular-text" placeholder="http://"/>（必填，一般是充值记录页面）
				</td>
			</tr>
			<tr>
